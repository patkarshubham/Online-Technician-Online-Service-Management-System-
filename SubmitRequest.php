...
<div class="col-sm-9 col-md-10 mt-5"> <!-- Start Service Request Form 2nd Column -->
 <form class="mx-5" action="" method="POST">
  ...
  <div class="form-group">
   ...
   <input type="text" class="form-control" id="inputName" placeholder="First-Name Last-Name" name="requestername">
  </div>
  <div class="form-row">
   ...
   <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" id="inputAddress2" placeholder="House-number Colony" name="requesteradd2">
   </div>
  </div>
  <div class="form-row">
   <div class="form-group col-md-6">
