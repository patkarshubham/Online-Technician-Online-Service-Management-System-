...
<head>
 ...
 <title>Online Technician</title>
</head>
<body>
 <!-- Start Navigation -->
 <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
  <a href="index.php" class="navbar-brand">Online Technician</a>
  ...
  <div class="collapse navbar-collapse" id="myMenu">
   <ul class="navbar-nav pl-5 custom-nav">
    ...
    <li class="nav-item"><a href="tech.php" class="nav-link">Services</a></li>
 ...
 <header class="jumbotron back-image" style="background-image:url(images/Banner1.jpg);">
  <div class="myclass mainHeading">
   ...
   <p class="font-italic">ग्राहक की खुशी ही हमारा उद्देश्य..</p>
 ...
 <div class="container text-center border-bottom" id="Services">
  ...
  <div class="row mt-4">
   <div class="col-sm-4 mb-4">
    <a href="tech.php"><i class="fas fa-tv fa-8x text-success"></i></a>
    <h4 class="mt-4">Electronic Appliances</h4>
   </div>
   <div class="col-sm-4 mb-4">
    <a href="tech.php"><i class="fas fa-sliders-h fa-8x text-primary"></i></a>
    <h4 class="mt-4">Preventive Maintenance</h4>
   </div>
   <div class="col-sm-4 mb-4">
    <a href="tech.php"><i class="fas fa-cogs fa-8x text-info"></i></a>
 ...
 <div class="jumbotron bg-danger">
   <div class="container">
    ...
    <h2 class="text-center text-white">हम अपने ग्राहकों पर गर्व करते हैं।</h2>
    <div class="row mt-5">
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">My first time experience for use online service with great facilities.</p>
       </div>
      </div>
     </div> <!-- End 1st Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">My mobile is completely damage shops are charged high price but osms is less charge for services.</p>
       </div>
      </div>
     </div> <!-- End 2nd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">Amazing experience for Repairing laptop with efficient price.</p>
       </div>
      </div>
     </div> <!-- End 3rd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 4th Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">It's a great era for any type technician services provider.</p>
       </div>
      </div>
     </div> <!-- End 4th Column -->
    </div>
 ...
 <div class="container" id="Contact">
  ...
  <h2 class="text-center mb-4">हम यहाँ मदद करने के लिए हैं।</h2>
  <div class="row">
   <!-- Start 1st Column -->
   ...
   <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
    ...
    Phone: +91 9999944444<br>
    <a href="index.php" target="_blank">www.osms.com</a><br>
    <br> <br>
    <strong>Branch:</strong><br>
    OSMS pvt Ltd,<br>
    New Ashok Nagar, Delhi<br>
    Delhi - 564567<br>
    Phone: +91 9999955555<br>
    <a href="index.php" target="_blank">www.osms.com</a><br>    
   </div> <!-- End 2nd Column -->
  </div>
 </div> <!-- End Contact US -->
  ...
  <div class="container">
   <div class="row py-3">
    <div class="col-md-6"> <!-- Start 1st Column -->
     ...
     <a href="www.facebook.com" target="_blank" class="pr-2 fi-color"><i class="fab fa-facebook-f"></i></a>
     <a href="www.twitter.com" target="_blank" class="pr-2 fi-color"><i class="fab fa-twitter"></i></a>
     <a href="www.youtube.com" target="_blank" class="pr-2 fi-color"><i class="fab fa-youtube"></i></a>
     <a href="www.googleapis.com" target="_blank" class="pr-2 fi-color"><i class="fab fa-google-plus-g"></i></a>
     <a href="www.rss.com" target="_blank" class="pr-2 fi-color"><i class="fas fa-rss"></i></a>
    </div> <!-- End 1st Column -->
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by Mahakaal &copy; 2022</small>
     <small class="ml-2" ><a class="pr-2 fi-color" href="Admin/login.php">Admin Login</a></small>
    </div> <!-- End 2nd Column -->
   </div>
  </div>
 </footer>
